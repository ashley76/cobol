      ...
      *JUST THE DETAIL LINES WITH A GRAND TOTAL AT END
      ...
      ***********************************************
      *  - Amusement Park Ticket Sales - 2B -       *
      * Program utilizes 2D Hard-Coded Table.       *
      * Uses sorted Park Dat, Normal Usage.         *
      ***********************************************
      ...
      * // -- Confirm Subtotal Line is Totals
       ...
       01  AMUSEMENT-PARKS   REDEFINES  AMUSEMENT-ARRAY.
           05  PARK-PRICES-ARRAY   OCCURS 15 TIMES.
               ...
               10  AMUSE-PRICE    PIC 9(2)V99   OCCURS  3 TIMES.
       ...
       01  COMPANY-TITLE-LINE.
           ...
           05  FILLER       PIC X(22)   VALUE 'CP2B - AMUSEMENT PARKS'.
           05  FILLER       PIC X(42)   VALUE SPACES.
           05  FILLER       PIC X(6)    VALUE 'PAGE: '.
           05  O-PCTR       PIC Z9.

       01  DETAIL-HEADING-LINE.
           05  FILLER       PIC X(8)    VALUE 'COBANL2B'.
