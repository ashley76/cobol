      ...
      ***********************************************
      *  - Amusement Park Ticket Sales - 2A -       *
      * Program utilizes 2D Hard-Coded Table.       *
      * Uses sorted Park Dat, Subtotaling By Park.  *
      ***********************************************


      * // -- Confirm Subtotal Line is Totals
       ...
       01  WORK-AREA.
           ...
           05  PARK-HOLD       PIC 99        VALUE ZERO.
       ...
       01  PACKED-ATTEND-DATE.
           05  ATTEND-YEAR     PIC 9(4).
           05  ATTEND-MONTH    PIC 99.
           05  ATTEND-DAY      PIC 99.
       01  ATTEND-DATE  PIC 9(8)  REDEFINES  PACKED-ATTEND-DATE.
       ...
       01  COMPANY-TITLE-LINE.
           ...
           05  FILLER       PIC X(22)   VALUE 'CP2A - AMUSEMENT PARKS'.
           05  FILLER       PIC X(42)   VALUE SPACES.
           05  FILLER       PIC X(6)    VALUE 'PAGE: '.
           05  O-PCTR       PIC Z9.

       01  DETAIL-HEADING-LINE.
           05  FILLER       PIC X(8)    VALUE 'COBANL1A'.
           05  FILLER       PIC X(55)   VALUE SPACES.
           05  FILLER       PIC X(21)   VALUE 'SUBTOTAL SALES REPORT'.
       ...
       2000-MAINLINE.
           ...
           IF PARK-HOLD NOT EQUAL TO I-PARK
       ...
       2100-SUBTOTAL.
           ...
           MOVE AMUSE-PARK(I-PARK) TO O-AMUSE-PARK of SUB-LINE.
